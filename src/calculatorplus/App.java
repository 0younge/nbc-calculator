...
public class App {
    ...
    public static void main(String[] args) {
        ...
        while (keep) {
            ...
            // 게터 활용
            System.out.println("현재까지 계산 결과(오래된 순): " + calculator.getResultList());

            // 오래된 기록 지우기
            System.out.println("가장 오래된 계산 결과를 지우시겠습니까?");
            System.out.print("yes 입력시 가장 오래된 계산 결과 삭제/ 그 외 입력시 취소: ");
            removeOldResult = sc.nextLine();
            if (removeOldResult.equals("yes")) {
                calculator.removeOldResultList();
            }
            System.out.println("현재까지 계산 결과(오래된 순): " + calculator.getResultList());
